                    ...
                    <section class="border-b border-stone-200 bg-white">
                        <div class="mx-auto grid max-w-screen-2xl gap-5 px-5 py-6 lg:grid-cols-[1fr_auto] lg:items-end">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <form method="post" action="/task" data-confirm="Der aktuelle REWE-Warenkorb wird geleert und ersetzt."><input type="hidden" name="csrf" value="{$csrf}"><input type="hidden" name="action" value="order"><input type="hidden" name="year" value="{$year}"><input type="hidden" name="week" value="{$week}">{$filterFields}<button title="{$orderTitle}" class="flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium {$orderStyle}"{$orderDisabled}><i data-lucide="shopping-cart" class="size-4"></i>Woche bestellen</button></form>
                                <form method="post" data-confirm="Wirklich alle Rezepte, Zutatenzuordnungen, Bewertungen, Notizen und Bestellungen löschen?"><input type="hidden" name="csrf" value="{$csrf}"><input type="hidden" name="action" value="reset"><input type="hidden" name="year" value="{$year}"><input type="hidden" name="week" value="{$week}">{$filterFields}<button title="Alle Rezeptdaten löschen" class="flex items-center gap-2 rounded-md border border-red-200 bg-white px-3 py-2 text-sm font-medium text-red-700 hover:bg-red-50"><i data-lucide="trash-2" class="size-4"></i>Reset</button></form>
                            </div>
                        </div>
                    </section>
